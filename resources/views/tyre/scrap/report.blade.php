<!-- resources/views/tyre/scrap/report.blade.php -->
...
<div class="page-header">
    <div class="page-title">
        <h4>Scrap Report</h4>
        <h6>Detailed scrap tyres report</h6>
    </div>
</div>
            ...
            <table class="table table-hover datatable">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $record->tyre->serial_number }}</td>
                        <td>{{ $record->tyre->brand }}</td>
                        <td>{{ $record->tyre->size }}</td>
