<!-- resources/views/tyre/refilling/pdf.blade.php -->
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <div class="pdf-wrapper" id="pdfContent">
        <div class="pdf-content">
            ...
            <div class="title-section">
                ...
                <div class="subtitle">Tyre Refilling/Retreading Order</div>
            ...
            <!-- Tyres Table -->
            <h4 style="color: #1b2850; margin-bottom: 10px;">Tyres for Refilling</h4>
