<!-- resources/views/tyre/refilling/vendors_edit.blade.php -->
...
<div class="page-header d-flex justify-content-between align-items-center">
    ...
    <div class="page-btn">
        ...
        <!-- <a href="{{ route('tyre.refilling.vendors.show', $vendor->id) }}" class="btn btn-info">
...
<div class="card">
    ...
    <div class="card-body">
        <form action="{{ route('tyre.refilling.vendors.update', $vendor->id) }}" method="POST">
            @csrf
            @method('PUT')
            <div class="row">
                <div class="col-lg-6">
            ...
            <div class="text-end mt-3">
                ...
                <a href="{{ route('tyre.refilling.vendors') }}" class="btn btn-secondary">
