<!-- resources/views/tyre/refilling/vendors.blade.php -->
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="action-buttons">
                                <!-- Show Button -->
                                <a href="{{ route('tyre.refilling.vendors.show', $vendor->id) }}" class="action-btn action-btn-view" title="View Vendor Details">
                                    <i class="fas fa-eye"></i>
                                </a>
                                
                                <!-- Edit Button -->
                                <a href="{{ route('tyre.refilling.vendors.edit', $vendor->id) }}" class="action-btn action-btn-edit" title="Edit Vendor">
...
<script>
    ...
    function editVendor(vendorId) {
        window.location.href = '{{ url("tyre/refilling/vendors") }}/' + vendorId + '/edit';
    }
    ...
    function deleteVendor(vendorId) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: '{{ url("tyre/refilling/vendors") }}/' + vendorId + '/delete',
                    type: 'DELETE',
                    data: {
                        _token: '{{ csrf_token() }}'
                    },
