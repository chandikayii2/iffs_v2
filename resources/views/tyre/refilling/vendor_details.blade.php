<!-- resources/views/tyre/refilling/vendor_details.blade.php -->
...
<div class="page-header d-flex justify-content-between align-items-center">
    ...
    <div class="page-btn">
        <a href="{{ route('tyre.refilling.vendors.manage') }}" class="btn btn-secondary">
            <i class="fas fa-arrow-left me-1"></i> Back to Vendors
        </a>
        <!-- <a href="{{ route('tyre.refilling.vendors.edit', $vendor->id) }}" class="btn btn-primary">
                ...
                <div class="row text-center">
                    ...
                    <div class="col-6 mb-3">
                        <div class="dash-count das4" style="background: linear-gradient(135deg, #E74C3C, #C0392B);">
                            <div class="dash-counts">
                                <h4 style="color: white;">
                                    Rs. {{ number_format($vendor->refillingOrders->sum('total_cost'), 2) }}
                                </h4>
                                <h5 style="color: white;">Total Value</h5>
                            </div>
                            <div class="dash-imgs">
                                <i class="fas fa-money-bill-wave" style="color: white; opacity: 0.5;"></i>
                            </div>
                        </div>
                    </div>
                </div>
...
<div class="card mt-4">
    <div class="card-header bg-light d-flex justify-content-between align-items-center">
        ...
        <a href="{{ route('tyre.refilling.index') }}" class="btn btn-sm btn-outline-primary">
                    ...
                    <tr>
                        ...
                        <td>
                            <span class="badge badge-soft-primary">
                                {{ $order->tyres->count() }} tyres
                            </span>
                        </td>
                        <td>
                            <a href="{{ route('tyre.refilling.show', $order->id) }}" class="action-btn action-btn-view" title="View Order">
