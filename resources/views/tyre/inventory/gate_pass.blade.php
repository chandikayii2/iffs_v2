<!-- resources/views/tyre/inventory/gate_pass.blade.php -->
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Gate Pass - {{ $tyre->serial_number }}</title>
...
<body>
    ...
    <div class="gate-pass-wrapper" id="gatePassContent">
        <div class="gate-pass">
            ...
            <div class="title-section">
                <h1>Gate Pass</h1>
                <div class="subtitle">Tyre Movement Authorization</div>
                <div class="date">
    ...
    <tr>
        ...
        <td class="value">{{ $tyre->serial_number }}</td>

        <td class="label">Brand</td>
        <td class="value">{{ $tyre->brand }}</td>
    </tr>

    <tr>
        <td class="label">Size</td>
        <td class="value">{{ $tyre->size }}</td>

        <td class="label">Type</td>
        <td class="value">{{ $tyre->type }}</td>
    </tr>

    <tr>
        <td class="label">Status</td>
        <td class="value">
            <span class="status-badge {{ str_replace('_', '', $tyre->status) }}">
        ...
        <td class="value">
            {{ $tyre->vendor ? $tyre->vendor->name : 'N/A' }}
        </td>
    </tr>
    ...
    <tr>
        ...
        <td class="value">
            @php
                $locationText = ucfirst(str_replace('_', ' ', $tyre->current_location ?? 'Store'));

                if(
                    $tyre->status == 'in_use' &&
                    $tyre->currentAllocation &&
                    $tyre->currentAllocation->vehicle
                ){
                    $locationText = 'Vehicle: ' .
                    $tyre->currentAllocation->vehicle->lorry_number;
                }
            @endphp
        ...
        <td class="value">
            ...
            <div class="info-box">
                <p>
                    ...
                    <strong>Important:</strong> This gate pass authorizes the movement of the above-mentioned tyre.
            ...
            <div class="footer">
                <p>
                    ...
                    This is a computer-generated gate pass. Please verify the tyre details before signing.
                </p>
                <p>
    ...
    filename: 'GatePass_{{ $tyre->serial_number }}.pdf',
