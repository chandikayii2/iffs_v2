<!-- resources/views/tyre/issue/pdf.blade.php -->
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <div class="pdf-wrapper" id="pdfContent">
        <div class="pdf-content">
            ...
            <div class="title-section">
                <h1>Issue Note</h1>
                <div class="subtitle">Tyre Issue Document</div>
            ...
            <!-- Tyres Table -->
            <h4 style="color: #1b2850; margin-bottom: 10px;">Issued Tyres</h4>
            <table class="items-table">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>{{ $index + 1 }}</td>
                        <td><strong>{{ $item->tyre->serial_number }}</strong></td>
            ...
            <!-- Footer -->
            <div class="footer">
                <p>This is a computer-generated document. Please verify the tyre details before processing.</p>
