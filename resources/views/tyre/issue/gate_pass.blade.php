<!-- resources/views/tyre/issue/gate_pass.blade.php -->
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <div class="gate-pass-wrapper" id="gatePassContent">
        <div class="gate-pass">
            ...
            <table class="details-table">
                ...
                <tr>
                    <td class="label">Total Tyres</td>
                    <td class="value">{{ $issueNote->items->count() }}</td>
                    <td class="label">Purpose</td>
                    <td class="value">Tyre Movement / Transfer</td>
                </tr>
            </table>

            <!-- Tyres Table -->
            <table class="tyres-table">
                <thead>
                    <tr>
                        <th width="40">#</th>
