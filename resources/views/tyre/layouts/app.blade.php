...
<head>
    ...
    <meta name="description" content="Tyre Lifecycle Management System">
    <meta name="author" content="IDEAL SOFT">
    <title>Tyre Management System - IFFS</title>
...
.sidebar-menu ul li.submenu ul li.active a {
    ...
    color: #ff9f43 !important;
        ...
        .btn:hover {
            ...
            box-shadow: 0 5px 11px rgba(0, 0, 0, 0.14) !important;
        }
...
<body>
    ...
    <div class="main-wrapper">
        <div class="header">
            <div class="header-left active">
                <a href="{{ route('tyre.dashboard') }}" class="logo">
    ...
    <script>
        $(document).ready(function() {
            ...
            // First turn off any duplicate click handlers registered by script.js
