<!-- resources/views/tyre/vehicles/edit.blade.php -->
...
<div class="page-header d-flex justify-content-between align-items-center">
    ...
    <div class="page-btn">
        <a href="{{ route('tyre.vehicles.show', $vehicle->id) }}" class="btn btn-secondary">
...
<div class="card">
    ...
    <div class="card-body">
        <form action="{{ route('tyre.vehicles.update', $vehicle->id) }}" method="POST">
            @csrf
            @method('PUT')
            <div class="row">
                <div class="col-lg-12">
