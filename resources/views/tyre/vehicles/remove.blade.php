<!-- resources/views/tyre/vehicles/remove.blade.php -->
@extends('tyre.layouts.app')

@section('content')
<div class="page-header d-flex justify-content-between align-items-center">
    <div class="page-title">
        <h4><i class="fas fa-trash-alt me-2"></i>Remove Tyre from Vehicle</h4>
        <h6>{{ $allocation->tyre->serial_number }} from {{ $allocation->vehicle->lorry_number }}</h6>
    </div>
    <div class="page-btn">
        <a href="{{ route('tyre.vehicles.show', $allocation->vehicle_id) }}" class="btn btn-secondary">
            <i class="fas fa-arrow-left me-1"></i> Back to Vehicle
        </a>
    </div>
</div>

<form action="{{ route('tyre.vehicles.remove.process', $allocation->id) }}" method="POST">
    @csrf
    <div class="card">
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-lg-6">
                    <div class="form-group">
                        ...
                        <p><strong>{{ $allocation->tyre->serial_number }}</strong></p>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="form-group">
            ...
            <div class="text-end">
                ...
                <a href="{{ route('tyre.vehicles.show', $allocation->vehicle_id) }}" class="btn btn-secondary">Cancel</a>
            </div>
        </div>
    </div>
</form>
